...
fun main() = model("cabinet1", "Шкаф непонятный") {
    ...
    val внутренняя_z_верхней_части = внутренняя_глубина_верхней_части / 2
    ...
    element(основной_материал) {
        ...
        y = высота - ширина_материала - высота_верхних_ящиков - высота_правой_стенки_левого_ящика / 2
        z = внутренняя_z_верхней_части
        dx = ширина_материала
