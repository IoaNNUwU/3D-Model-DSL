...
fun main() = model("cabinet1", "Шкаф непонятный") {
    ...
    val нижний_ящик = Property("downYaAngle", "Нижний ящик", 0, 2000) { 13 }
    ...
    val смещение_вниз = -0.7 * половина_высоты
    ...
    element(основной_материал) {
        ...
        y = половина_высоты_нижнего_ящика + половина_высоты_нижнего_ящика_над_полом - половина_ширины_материала + смещение_вниз
    ...
    element(основной_материал) {
        ...
        y = высота_нижнего_ящика + высота_нижнего_ящика_над_полом - половина_ширины_материала + смещение_вниз
        z = половина_глубины_нижней_части
    ...
    element(основной_материал) {
        ...
        y = высота_нижнего_ящика_над_полом + половина_ширины_материала + смещение_вниз
        z = половина_глубины_нижней_части
    ...
    element(основной_материал) {
        ...
        y = половина_высоты_стола + смещение_вниз
        z = половина_глубины_нижней_части
        dx = ширина_материала
        dy = высота_стола
        dz = глубина_нижней_части
    ...
    element(основной_материал) {
        ...
        y = высота_стола + половина_ширины_материала + смещение_вниз
        z = половина_глубины_нижней_части
        dx = ширина_стола
        dy = ширина_материала
        dz = глубина_нижней_части
    ...
    element(основной_материал) {
        x = половина_ширины + половина_ширины_материала
        y = половина_высоты + смещение_вниз
    ...
    element(основной_материал) {
        ...
        y = высота_стола - высота_распорки / 2 + смещение_вниз
    ...
    element(основной_материал) {
        x = -половина_ширины - половина_ширины_материала
        y = высота_нижнего_ящика_над_полом + высота_нижнего_ящика + высота_верхней_части_стенки / 2 + смещение_вниз
        z = половина_глубины_верхней_части
        dx = ширина_материала
    ...
    element(основной_материал) {
        x = 0.toProperty()
        y = высота - половина_ширины_материала + смещение_вниз
        z = половина_глубины_верхней_части
        dx = ширина
        dy = ширина_материала
        dz = глубина_верхней_части
    ...
    element(основной_материал) {
        x = 0.toProperty()
        y = y_нижней_грани_верхних_шкафов + половина_ширины_материала + смещение_вниз
    ...
    element(основной_материал) {
        ...
        x = 0.toProperty()
        y = y_нижней_грани_верхних_шкафов + ширина_материала + высота_доски / 2 + смещение_вниз
    ...
    element(основной_материал) {
        ...
        y = y_нижней_грани_верхних_шкафов - внутренняя_высота_полки - половина_ширины_материала + смещение_вниз
        z = половина_внутренней_глубины_верхней_части
        dx = ширина_полки
        dy = ширина_материала
        dz = внутренняя_глубина_верхней_части
    ...
    for (i in 0..2) {
        element(белый_материал) {
            ...
            y = y_нижней_грани_верхних_шкафов - высота_раздела / 2 + смещение_вниз
    ...
    element(основной_материал) {
        ...
        y = y_правой_стенки_левого_ящика + смещение_вниз
        z = половина_внутренней_глубины_верхней_части
        dx = ширина_материала
    ...
    element(основной_материал) {
        x = -половина_ширины + половина_ширины_нижнего_ящика
        y = высота_нижнего_ящика_над_полом + половина_высоты_нижнего_ящика + смещение_вниз
        z = половина_ширины_материала
        dx = ширина_нижнего_ящика
    ...
    element(основной_материал) {
        x = половина_ширины_бокового_ящика
        y = y_нижней_грани_верхних_шкафов - внутренняя_высота_полки / 2 + смещение_вниз
        z = половина_ширины_материала
        dx = ширина_полки
    ...
    element(белый_материал) {
        ...
        x = половина_ширины / 2
        y = y_без_вращения + (cos(a) - 1) * dy_без_вращения / 2 + смещение_вниз
    ...
    element(белый_материал) {
        ...
        x = x_без_вращения + (cos(a) - 1) * dx_без_вращения / 2
        y = высота_нижнего_ящика_над_полом + высота_нижнего_ящика + высота_правой_стенки_левого_ящика / 2 + смещение_вниз
        z = z_без_вращения + dx_без_вращения / 2 * sin(a)
        dx = ширина_бокового_ящика - зазор
        dy = высота_правой_стенки_левого_ящика - зазор
        dz = ширина_материала_дверцы
        py = -a
    }
    ///// Выдвижной ящик /////
    val сдвиг_z = нижний_ящик
    val размер_колёсиков = 60 // отступ слева и справа относительно стенок ящика
    val отступ = 10 // отступ снизу и сверху относительно верха и низа ящика
    // Дверца
    element(белый_материал) {
        x = -половина_ширины + половина_ширины_нижнего_ящика
        y = высота_нижнего_ящика_над_полом + половина_высоты_нижнего_ящика + смещение_вниз
        z = глубина_нижней_части - ширина_материала_дверцы / 2 + сдвиг_z
        dx = ширина_нижнего_ящика - зазор
        dy = высота_нижнего_ящика - 2 * ширина_материала - зазор
        dz = ширина_материала_дверцы
    }
    // Задняя стенка
    element(основной_материал) {
        x = -половина_ширины + половина_ширины_нижнего_ящика
        y = высота_нижнего_ящика_над_полом + половина_высоты_нижнего_ящика + смещение_вниз
        z = ширина_материала + половина_ширины_материала + сдвиг_z
        dx = ширина_нижнего_ящика - 2 * размер_колёсиков
        dy = высота_нижнего_ящика - 2 * ширина_материала - 2 * отступ
        dz = ширина_материала
    }
    // Пол
    val внутренняя_глубина_полки = глубина_нижней_части - 2 * ширина_материала - ширина_материала_дверцы
    element(основной_материал) {
        x = -половина_ширины + половина_ширины_нижнего_ящика
        y = высота_нижнего_ящика_над_полом + ширина_материала + отступ + половина_ширины_материала + смещение_вниз
        z = 2 * ширина_материала + внутренняя_глубина_полки / 2 + сдвиг_z
        dx = ширина_нижнего_ящика - 2 * размер_колёсиков
        dy = ширина_материала
        dz = внутренняя_глубина_полки
    }

    // Стенки
    element(основной_материал) {
        x = -половина_ширины + размер_колёсиков + половина_ширины_материала
    }
    element(основной_материал) {
        x = -половина_ширины + ширина_нижнего_ящика - размер_колёсиков - половина_ширины_материала
    }
}