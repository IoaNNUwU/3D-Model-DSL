...
fun main() = model("cabinet1", "Шкаф непонятный") {
    ...
    y = - (0.7 * половина_высоты)
    z = - (0.5 * половина_ширины)
    ...
    element(основной_материал) {
        x = -половина_ширины + половина_ширины_нижнего_ящика
        y = высота_нижнего_ящика_над_полом + ширина_материала + отступ + половина_ширины_материала 
    ...
    element(основной_материал) {
        ...
        y = высота_нижнего_ящика_над_полом + половина_высоты_нижнего_ящика - половина_ширины_материала
        z = 2 * ширина_материала + внутренняя_глубина_полки / 2 + сдвиг_z
        dx = ширина_материала
        dy = высота_нижнего_ящика_над_полом + половина_высоты_нижнего_ящика - ширина_материала
        dz = внутренняя_глубина_полки
    }
    element(основной_материал) {
