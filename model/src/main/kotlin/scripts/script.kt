...
fun main() = model("cabinet1", "Шкаф непонятный") {
    ...
    val размер_колёсиков = 10 // отступ слева и справа относительно стенок ящика
    ...
    // Пол
    val внутренняя_глубина_полки = глубина_нижней_части - ширина_материала - ширина_материала_дверцы
    element(основной_материал) {
        x = -половина_ширины + половина_ширины_нижнего_ящика
    ...
    // Стенки
    element(основной_материал) {
        x = -ширина + размер_колёсиков + половина_ширины_нижнего_ящика
        // TODO
    }
    element(основной_материал) {
